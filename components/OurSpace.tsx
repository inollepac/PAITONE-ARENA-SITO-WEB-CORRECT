    ...
    <div className="py-20 max-w-7xl mx-auto px-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
            <h1 className="text-5xl font-extrabold leading-tight uppercase italic text-brand-blue tracking-tighter">Uno spazio per ritrovarsi.</h1>
            ...
            <div className="space-y-6">
                ...
                <div className="p-6 bg-white rounded-3xl border border-brand-green/10 shadow-sm flex gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-brand-blue/50 text-sm italic">Un'area bar accogliente dove commentare la partita davanti a un buon caffè o un aperitivo.</p>
                    </div>
                </div>
            </div>
        </div>
